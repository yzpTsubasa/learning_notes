...
def sendStart2DingTalk() {
    ...
    dingtalk(
        ...
        text: [
            ...
            "- 时刻 ${new Date().format("yyyy-MM-dd(E)HH:mm:ss", TimeZone.getTimeZone('Asia/Shanghai'))}",
            "- 记录",
            "***",
        ] + getChangeString()
    )
...
def sendResult2DingTalkTest() {
    ...
    dingtalk(
        ...
        text: [
            ...
            "2. **时刻** ${new Date().format("yyyy-MM-dd(E)HH:mm:ss", TimeZone.getTimeZone('Asia/Shanghai'))}",
            "3. **用时** ${durationString}",
            "4. **记录**",
            "***",
        ] + getChangeString() + (
